...
export default function Terms() {
  return (
    ...
    <p>We aim to get your goodies to you as fast as possible. Check out our Shipping Policy for estimated delivery times and any additional information. We appreciate your patience and understanding.</p>

    <h2>6. Returns and Exchanges</h2>
    <p>Not completely satisfied with your purchase? No worries! Our Returns and Exchanges Policy explains the process to make things right. We want you to be happy with your shopping experience.</p>

    <h2>7. User Accounts</h2>
    <p>Creating an account with us allows you to track orders, save your favorite items, and breeze through the checkout process. Keep your login credentials safe, and let us know if you suspect any unauthorized access.</p>

    <h2>8. Reviews and Feedback</h2>
    <p>We love hearing from you! Share your thoughts on products through reviews. However, remember to keep it friendly and constructive. We reserve the right to moderate and remove inappropriate content.</p>

    <h2>9. Intellectual Property</h2>
    <p>All content on our website, including images, text, and logos, is our property or used with permission. Please don’t reproduce, distribute, or use it without our consent.</p>
    ...
    <p><strong>Last Updated: 20 December 2023.</strong></p>
</div>
